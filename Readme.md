...
> 5년간 방치된 **27 GPU 레거시 클러스터를 단독으로 재설계·재구축**하여
> Kubernetes 기반 AI 학습 인프라와 ML 파이프라인으로 전환했습니다.
>
> 단순 복구가 아닌 **"재구축 vs 패치"의 판단 근거를 직접 검증한 뒤 전면 재설계**를 선택했고,
> GPU 자원 관리 · 10GbE 네트워크 최적화 · 팀 학습 환경 · 워크플로우 자동화까지 운영 가능한 수준으로 구성했습니다.
...
| 문서                                                                            | 내용                                   |
| ------------------------------------------------------------------------------- | -------------------------------------- |
| [AI 클러스터 복구 1](./docs/1.cheetah-복구/3_12_AI_클러스터_복구_1.md)          | OS 루트 권한 복구 및 패스워드 초기화   |
