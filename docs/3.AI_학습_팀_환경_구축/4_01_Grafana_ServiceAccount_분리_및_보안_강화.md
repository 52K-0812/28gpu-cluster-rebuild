...
for ip in (control-plane-public-ip) (control-plane-public-ip) (control-plane-public-ip) (control-plane-public-ip) (control-plane-public-ip) (control-plane-public-ip); do
...
**Tailscale 접속 (`http://(vpn-endpoint)8000`):**
