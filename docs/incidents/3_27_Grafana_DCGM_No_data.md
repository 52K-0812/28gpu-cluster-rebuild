# 🛡️ [트러블슈팅] Grafana NVIDIA DCGM Dashboard — No data

> **작업 일자:** 2026-03-27
> **대상:** kube-prometheus-stack + NVIDIA GPU Operator v26.3.0
> **환경:** Kubernetes v1.29, Ubuntu 22.04 LTS
> **증상:** Grafana DCGM 대시보드 전체 패널 'No data' — GPU 메트릭 미수집
> **결과:** ServiceMonitor 라벨 불일치 수정으로 전 GPU 노드 메트릭 수집 정상화
