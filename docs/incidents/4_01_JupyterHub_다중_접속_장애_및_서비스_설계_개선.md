# 🛡️ [트러블슈팅] JupyterHub 다중 접속 장애 및 서비스 설계 개선

> **작업 일자:** 2026-04-01
> **대상:** master-01, ai-team 네임스페이스, 클러스터 전체 서비스
> **환경:** Kubernetes v1.29, MetalLB, Calico CNI, Ubuntu 22.04 LTS
> **증상:** JupyterHub 팀 동시 접속 시 세션 끊김, Calico CrashLoopBackOff
> **결과:** port-forward 제거 + MetalLB IP Pool 교체 + 서비스 구조 전면 재설계로 안정화
