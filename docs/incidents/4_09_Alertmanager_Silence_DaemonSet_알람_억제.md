# 🛡️ [트러블슈팅] Alertmanager Silence — DaemonSet 알람 억제

> **작업 일자:** 2026-04-09
> **대상:** `ai-team/continuous-image-puller` DaemonSet
> **환경:** Kubernetes v1.29, kube-prometheus-stack, JupyterHub
> **증상:** master-01 NoSchedule taint로 인한 `KubeDaemonSetRolloutStuck` / `KubeDaemonSetMisScheduled` 오탐 알람 지속 수신
> **결과:** AlertManager Silence 1년 등록으로 오탐 알람 수신 중단 확인
...
Prometheus가 아래 두 알람을 지속적으로 발생시켜 알람 메일이 반복 수신됨.
