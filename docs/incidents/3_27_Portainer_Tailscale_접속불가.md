# 🛡️ [트러블슈팅] Portainer Tailscale 접속 불가 — port-forward 좀비 상태

> **작업 일자:** 2026-03-27
> **대상:** `kubectl-portainer.service` (systemd port-forward), Portainer 9443 포트
> **환경:** Kubernetes v1.29, Tailscale VPN, Ubuntu 22.04 LTS
> **증상:** Tailscale VPN 통해 Portainer 접속 시 연결 불가 (서비스 자체는 정상)
> **결과:** port-forward 좀비 프로세스 확인 → systemd 서비스 재시작으로 즉시 복구
